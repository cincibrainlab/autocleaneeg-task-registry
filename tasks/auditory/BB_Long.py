"""Broadband Long auditory task.

This task processes long-duration broadband auditory stimulation data
with comprehensive artifact rejection and regular epoching.
"""
...
class BB_Long(Task):
    """Task for long-duration broadband auditory stimulation."""
