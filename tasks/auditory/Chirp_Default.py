"""Chirp auditory stimulation task.

This task processes chirp paradigm EEG data with event-related epoching
and comprehensive artifact rejection.
"""
...
class Chirp_Default(Task):
    """Task for chirp auditory stimulation paradigms."""
