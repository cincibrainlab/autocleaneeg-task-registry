"""HBCD Mismatch Negativity task.

This task implements the HBCD study protocol for mismatch negativity
(oddball paradigm) with standard/deviant event processing.
"""
...
class HBCD_MMN(Task):
    """Task for HBCD study mismatch negativity protocol."""
