...
This task implements resting-state protocol for rodent recordings using
MEA30 electrode arrays with correlation-based artifact rejection optimized
...
class Mouse_XDAT_Resting(Task):
    """Task for mouse resting-state recordings with correlation-based artifact rejection."""
