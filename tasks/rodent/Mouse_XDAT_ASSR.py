"""Mouse XDAT ASSR task.

This task implements the ASSR (Auditory Steady-State Response) protocol
for rodent recordings using MEA30 electrode arrays with correlation-based
artifact rejection optimized for preclinical studies.
"""
...
class Mouse_XDAT_ASSR(Task):
    """Task for mouse ASSR recordings with correlation-based artifact rejection."""
