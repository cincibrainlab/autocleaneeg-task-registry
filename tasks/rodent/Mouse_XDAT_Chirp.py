...
This task implements the chirp auditory stimulation protocol for rodent
recordings using MEA30 electrode arrays with correlation-based artifact
rejection optimized for preclinical studies.
"""
...
class Mouse_XDAT_Chirp(Task):
    """Task for mouse chirp recordings with correlation-based artifact rejection."""
