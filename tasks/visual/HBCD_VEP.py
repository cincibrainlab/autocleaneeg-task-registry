"""HBCD Visual Evoked Potential task.

This task implements the HBCD study protocol for visual evoked potentials
with event-related processing and artifact rejection.
"""
...
class HBCD_VEP(Task):
    """Task for HBCD study visual evoked potential protocol."""
